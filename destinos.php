...
<div class="destinosContainer">
  ...
  <a href="#" target="_blank">
    ...
    <aside class="ibizaAndorra ibiza">
      <img class="ibizaImg" src="img/ibiza.jpg" alt="grupo-de-jovenes-con-mediterraneo-de-fondo">
    </aside>
  </a>

  <img class="logoIbizaAndorra" src="img/logo-blanco.png" alt="Logo-CBbC-en-blanco">
